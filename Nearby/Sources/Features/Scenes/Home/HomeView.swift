...
//  Nearby
//
//  Created by Paulo Henrique Torres on 14/12/24.
//
...
class HomeView: UIView {
     private var filterButtonAction: ((CategoryModel) -> Void)?
    ...
    private let descriptionLabel: UILabel = {
        ...
        label.text = "Explore locaia perto de você"
        return label
    }()
    ...
    func updateFilterButtons(with categories: [CategoryModel], action: @escaping (CategoryModel) -> Void) {
